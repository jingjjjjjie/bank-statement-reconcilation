...
export const pageHelp = {
  ...
  ExtractionReview: ['Review extraction', [
    ...
    'Two receipts or two payees are separate pieces; purchase lines on one receipt are one piece. Use Add entry for a missed receipt. The highlighted entry is selected; Remove deletes it from the extraction. The icon beside the filename shows review status. Accept saves your review without moving. Accept and Discard switch directly between statuses; Undo is optional. Undo accept reopens it and keeps corrections. After editing an accepted document, use Accept again. Discard, Undo discard, Accept and Undo accept are separate buttons; unavailable actions stay visible in grey. Next opens the following document separately. Accept all saves all ready results, including current edits; trash and unresolved results are skipped. Bank matches still require separate review.',
