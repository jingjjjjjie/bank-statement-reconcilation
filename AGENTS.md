...
- Before final-comparison work, read `FINAL_COMPARISON.md` for the agreed two-page review/export workflow and open decisions. Implementation is deferred until both input branches are ready.
