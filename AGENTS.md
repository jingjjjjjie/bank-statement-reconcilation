...
- Before final-comparison work, read `docs/FINAL_COMPARISON.md` for the implemented frozen-snapshot review/report, agreed review workflow and open decisions. General matching import from newly prepared workspaces remains deferred until both input branches are ready; do not treat the frozen-snapshot implementation as that integration.
