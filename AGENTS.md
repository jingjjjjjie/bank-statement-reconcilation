...
- Follow `docs/UI_GUIDELINES.md` for dashboard changes: concise copy, one page-help circle, and one navigation control per page.
...
- Before final-comparison work, read `docs/FINAL_COMPARISON.md` for the implemented frozen-snapshot review/report, agreed review workflow and open decisions. The user authorized the live piece pipeline; preserve its documented migration, evidence binding, and single-ledger rules.
