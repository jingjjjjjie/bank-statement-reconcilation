...
class MatchingReviewBrowserTests(unittest.TestCase):
    def test_approve_deny_undo_candidates_and_reload(self):
        ...
        with sync_playwright() as playwright:
            ...
            page.locator('#matching-reviewer').fill('Browser tester')
            page.locator('#approve-match').click()
            expect(page.locator('#save-status')).to_contain_text('Saved by Browser tester')
            ...
            expect(page.locator('#save-status')).to_have_text('No human decision yet.')
