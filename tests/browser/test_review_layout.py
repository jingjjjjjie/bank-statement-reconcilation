...
class ReviewLayoutTests(unittest.TestCase):
    def test_twenty_one_pieces_and_selected_actions(self):
        ...
        with sync_playwright() as playwright:
            ...
            expect(page.locator('#piece-count')).to_have_text('21 pieces')
            ...
            expect(page.locator('#selected-piece')).to_have_text('Selected: piece 21')
            expect(page.locator('#merge-piece')).to_be_disabled()
            page.locator('#add-receipt').click()
            expect(page.locator('#piece-count')).to_have_text('22 pieces')
            expect(page.locator('#selected-piece')).to_have_text('Selected: piece 22')
            ...
            for width in (900, 390, 360):
                ...
                if width < 650:
                    ...
                    page.locator('.piece-selection').scroll_into_view_if_needed()
